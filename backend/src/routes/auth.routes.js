...
import {registerUser,loginUser,getCurrentUser,logoutUser,refreshAccessToken} from "../controllers/auth.controlller.js";
...
authRouter.post("/register",allowFirstSuperAdmin, authorizeRoles("SUPER_ADMIN"),registerUser);
